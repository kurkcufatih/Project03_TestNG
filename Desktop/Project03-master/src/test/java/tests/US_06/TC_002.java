...
public class TC_002 {
    ...
    //Store Manager "Best Seller" kategorisini secer
    //Store Manager "Best Seller" kategorisinin secildigini gorur
    ...
    public void TC_002() {
        ...
        js.executeScript("arguments[0].scrollIntoView(true);", SpendinGoodPage.bestSeller);
        js.executeScript("arguments[0].click();", SpendinGoodPage.bestSeller);
