...
public class TC_008 {
    ...
    //Store Manager "Fashion" kategorisini secer
    //Store Manager "Fashion" kategorisinin secildigini gorur
    ...
    public void TC_008() {
        ...
        js.executeScript("arguments[0].scrollIntoView(true);", SpendinGoodPage.fashion);
        js.executeScript("arguments[0].click();", SpendinGoodPage.fashion);
