...
public class TC_005 {
    ...
    //Store Manager "RED" markasini secer
    //Store Manager "RED" markasinin secildigini gorur
    ...
    public void TC_005() {
        ...
        js.executeScript("arguments[0].scrollIntoView(true);", SpendinGoodPage.RED);
        js.executeScript("arguments[0].click();", SpendinGoodPage.RED);
        Assert.assertTrue(SpendinGoodPage.RED.isEnabled());
