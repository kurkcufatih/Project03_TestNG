...
public class TC_009 {
    ...
    //Store Manager "Toys & Games" kategorisini secer
    //Store Manager "Toys & Games" kategorisinin secildigini gorur
    ...
    public void TC_009() {
        ...
        js.executeScript("arguments[0].scrollIntoView(true);", SpendinGoodPage.toysGames);
        js.executeScript("arguments[0].click();", SpendinGoodPage.toysGames);
        Assert.assertTrue(SpendinGoodPage.toysGames.isEnabled());
