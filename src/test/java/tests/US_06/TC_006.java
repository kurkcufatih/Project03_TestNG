...
public class TC_006 {
    ...
    //Store Manager "Books & Music & Film" kategorisini secer
    //Store Manager "Books & Music & Film" kategorisinin secildigini gorur
    ...
    public void TC_006() {
        ...
        js.executeScript("arguments[0].scrollIntoView(true);", SpendinGoodPage.booksMusicFilm);
        js.executeScript("arguments[0].click();", SpendinGoodPage.booksMusicFilm);
