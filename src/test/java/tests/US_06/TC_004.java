...
public class TC_004 {
    ...
    //Store Manager "Home&Garden" kategorisini secer
    //Store Manager "Home&Garden" kategorisinin secildigini gorur
    ...
    public void TC_004() {
        ...
        js.executeScript("arguments[0].scrollIntoView(true);", SpendinGoodPage.homeAndGarden);
        js.executeScript("arguments[0].click();", SpendinGoodPage.homeAndGarden);
        Assert.assertTrue(SpendinGoodPage.homeAndGarden.isEnabled());
