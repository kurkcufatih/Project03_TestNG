...
public class TC_007 {
    ...
    //Store Manager "Health & Beauty" kategorisini secer
    //Store Manager "Health & Beauty" kategorisinin secildigini gorur
    ...
    public void TC_007() {
        ...
        js.executeScript("arguments[0].scrollIntoView(true);", SpendinGoodPage.healtBeautySec);
        js.executeScript("arguments[0].click();", SpendinGoodPage.healtBeautySec);
        Assert.assertTrue(SpendinGoodPage.healtBeautySec.isEnabled());
