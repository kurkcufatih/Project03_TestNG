...
public class TC_003 {
    ...
    //Store Manager "Electronics" kategorisini secer
    //Store Manager "Electronics" kategorisinin secildigini gorur
    ...
    public void TC_003() {
        ...
        js.executeScript("arguments[0].scrollIntoView(true);", SpendinGoodPage.electronics);
        js.executeScript("arguments[0].click();", SpendinGoodPage.electronics);
