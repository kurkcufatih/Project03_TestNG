...
public class TC_005 {
    ...
    //Store Manager "Indirimli Urunler" kategorisini secer
    //Store Manager "Indirimli Urunler" kategorisinin secildigini gorur
    ...
    public void TC_005() {
        ...
        js.executeScript("arguments[0].scrollIntoView(true);", SpendinGoodPage.indirimliUrunler);
        js.executeScript("arguments[0].click();", SpendinGoodPage.indirimliUrunler);
