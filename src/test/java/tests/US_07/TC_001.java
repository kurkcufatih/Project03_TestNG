...
public class TC_001 {
    ...
    //Store Manager "Elegant Auto group" markasini secer
    //Store Manager "Elegant Auto group" markasinin secildigini gorur
    ...
    public void TC_001() {
        ...
        js.executeScript("arguments[0].scrollIntoView(true);", SpendinGoodPage.elegantAutoGroup);
        js.executeScript("arguments[0].click();", SpendinGoodPage.elegantAutoGroup);
        Assert.assertTrue(SpendinGoodPage.elegantAutoGroup.isEnabled());
