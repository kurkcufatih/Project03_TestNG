...
public class TC_003 {
    ...
    //Store Manager "NodeJS" markasini secer
    //Store Manager "NodeJS" markasinin secildigini gorur
    ...
    public void TC_003() {
        ...
        js.executeScript("arguments[0].scrollIntoView(true);", SpendinGoodPage.nodeJS);
        js.executeScript("arguments[0].click();", SpendinGoodPage.nodeJS);
        Assert.assertTrue(SpendinGoodPage.nodeJS.isEnabled());
