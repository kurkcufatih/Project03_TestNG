...
public class TC_002 {
    ...
    //Store Manager "Green Grass" markasini secer
    //Store Manager "Green Grass" markasinin secildigini gorur
    ...
    public void TC_002() {
        ...
        js.executeScript("arguments[0].scrollIntoView(true);", SpendinGoodPage.greenGrass);
        js.executeScript("arguments[0].click();", SpendinGoodPage.greenGrass);
        Assert.assertTrue(SpendinGoodPage.greenGrass.isEnabled());
