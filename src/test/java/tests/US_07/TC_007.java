...
public class TC_007 {
    ...
    //Store Manager "Sterling" markasini secer
    //Store Manager "Sterling" markasinin secildigini gorur
    ...
    public void TC_007() {
        ...
        js.executeScript("arguments[0].scrollIntoView(true);", SpendinGoodPage.Sterling);
        js.executeScript("arguments[0].click();", SpendinGoodPage.Sterling);
        Assert.assertTrue(SpendinGoodPage.Sterling.isEnabled());
